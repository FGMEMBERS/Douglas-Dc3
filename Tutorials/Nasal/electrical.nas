...
var avionics_bus = func(bus_volts) {
    ...
    if (props.globals.getNode("/instrumentation/comm[0]/serviceable").getBoolValue() and props.globals.getNode("/sim/failure-manager/instrumentation/comm[0]/serviceable").getBoolValue()){
    ...
    if (props.globals.getNode("/instrumentation/comm[1]/serviceable").getBoolValue()){
