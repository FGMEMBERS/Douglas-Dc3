...
var Startup = func{
  ...
  setprop("controls/engines/engine[0]/mixture",0.561);
  setprop("controls/engines/engine[0]/cowl-flaps-cmd",2);
  setprop("/controls/engines/engine[1]/magnetos",3);
  setprop("controls/engines/engine[1]/propeller-pitch",1);
  setprop("controls/engines/engine[1]/mixture",0.561);
  setprop("controls/engines/engine[1]/cowl-flaps-cmd",2);
  setprop("controls/lighting/passing-lights",1);
  setprop("controls/lighting/running-lights",1);
  setprop("controls/lighting/tail-lights",1);
  setprop("controls/lighting/landing-lights[0]",1);
  setprop("controls/lighting/landing-lights[1]",1);
  setprop("/controls/gear/brake-parking",1);
  setprop("/instrumentation/doors/crew/position-norm",0);
  setprop("/controls/lighting/instruments-norm",0.04);
  setprop("autopilot/settings/heading-bug-deg",math.round(getprop('orientation/heading-magnetic-deg')));
...
var Shutdown = func{
  ...
  setprop("controls/engines/engine[0]/cowl-flaps-cmd",0);
  ...
  setprop("controls/engines/engine[1]/cowl-flaps-cmd",0);
  setprop("controls/lighting/passing-lights",0);
  setprop("controls/lighting/running-lights",0);
  setprop("controls/lighting/tail-lights",0);
...
var autopilot_active = func()
{
	var active = getprop('autopilot/active');

	if (active) {
		setprop('autopilot/locks/heading', 'dg-heading-hold');
		var pitch = getprop('instrumentation/attitude-indicator/indicated-pitch-deg');
		if (pitch > 8.6) pitch = 8.6; # Approximately 10* pitch up
		if (pitch < -6.4) pitch = -6.4; # Approximately 5* pitch down
		pitch = int(pitch * 10) / 10;
...
setlistener('autopilot/active', autopilot_active, startup=0, runtime=0);